...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'valo' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'valo' ),
		'repeat-y'  => __( 'Repeat Vertically', 'valo' ),
		'repeat'    => __( 'Repeat All', 'valo' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'valo' ),
		'top center'    => __( 'Top Center', 'valo' ),
		'top right'     => __( 'Top Right', 'valo' ),
		'center left'   => __( 'Middle Left', 'valo' ),
		'center center' => __( 'Middle Center', 'valo' ),
		'center right'  => __( 'Middle Right', 'valo' ),
		'bottom left'   => __( 'Bottom Left', 'valo' ),
		'bottom center' => __( 'Bottom Center', 'valo' ),
		'bottom right'  => __( 'Bottom Right', 'valo')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'valo' ),
		'fixed'  => __( 'Fixed in Place', 'valo')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'valo' ),
		'italic'      => __( 'Italic', 'valo' ),
		'bold'        => __( 'Bold', 'valo' ),
		'bold italic' => __( 'Bold Italic', 'valo' )
		);
